    ...
    <div class="wrapper">
        <header class="main-header" >
            ...
            <a href="<?php echo base_url()?>cdashboard" class="logo" id="menu3">
                ...
                <span class="logo-mini"><img src="<?php echo base_url()?>assets/template/dist/img/logo.jpg" id="imgSmall"></span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"> <img src="<?php echo base_url()?>assets/template/dist/img/logo.jpg" id="img"></span>
            </a>
